                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form class="row g-3 mt-2">
                                                        @foreach($oneNews as $oneImg)
                                                        <div class="col-6">
                                                            <div class="form-floating">
                                                                <h5 style="font-family: Helvetica; color:blue" >{{$oneImg['title']}}</h5>
                                                                <img src="{{$oneImg['imageUrl']}}" style="width: 100%; "alt="">
                                                                <p>{{$oneImg['name']}}</p>
                                                                <p>{{$oneImg['content']}}.
                                                                <a href="{{$oneImg['url']}}" target="_blank">More..</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        @endforeach
